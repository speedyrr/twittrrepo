/*
	From the default SvelteKit example
	https://github.com/sveltejs/kit/tree/master/packages/create-svelte/templates/default

	Replaced with SvelteKit's solution for forms
